...
(10,'消息管理',NULL,NULL,21,30),
(11,'写新消息','system/messagebox_new.html',NULL,22,23),
(12,'收件箱','system/messagebox_inbox.html',NULL,24,25),
(13,'已发消息','system/messagebox_sent.html',NULL,26,27),
(14,'草稿','system/messagebox_draft.html',NULL,28,29),
(15,'演示页面',NULL,NULL,201,400),
(16,'格式化文本框','demo1.html',NULL,202,203),
