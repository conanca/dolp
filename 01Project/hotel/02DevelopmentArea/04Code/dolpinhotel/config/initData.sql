...
(4,'用户角色分配','system/role_assign.jsp',NULL,6,7),
(5,'菜单管理','system/menu_manage.jsp',NULL,8,9),
(6,'角色可见菜单分配','system/menu_assign.jsp',NULL,10,11),
(7,'枚举管理','system/sysenum_mange.jsp',NULL,12,13),
(8,'演示页面',NULL,NULL,21,40),
(9,'格式化文本框','demo1.jsp',NULL,22,23),
(10,'酒店设置',NULL,NULL,51,70),
(11,'房间类型设置','hotel/room_type_manage.jsp',NULL,52,53),
(12,'房间设置','hotel/room_manage.jsp',NULL,54,55),
(13,'经营管理',NULL,NULL,71,100),
(14,'可用房确认','hotel/available_room_check.jsp',NULL,72,73),
(15,'入住情况','hotel/room_occupancy_manage.jsp',NULL,74,75),
(16,'入住登记','hotel/check_in.jsp',NULL,76,77),
(17,'账单管理','hotel/bill_manage.jsp',NULL,78,79);