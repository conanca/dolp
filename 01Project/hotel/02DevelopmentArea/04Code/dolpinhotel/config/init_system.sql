...
(10,'个人设置',NULL,NULL,201,300),
(11,'消息管理',NULL,NULL,202,250),
(12,'写新消息','system/messagebox_new.html',NULL,203,204),
(13,'收件箱','system/messagebox_inbox.html',NULL,205,206),
(14,'已发消息','system/messagebox_sent.html',NULL,207,208),
(15,'草稿','system/messagebox_draft.html',NULL,209,210),
(16,'修改密码','system/change_pwd.html',NULL,251,252),
(17,'演示页面',NULL,NULL,301,400),
(18,'格式化文本框','demo1.html',NULL,302,303),
(19,'酒店设置',NULL,NULL,501,700),
(20,'房间类型设置','hotel/room_type_manage.html',NULL,502,503),
(21,'房间设置','hotel/room_manage.html',NULL,504,505),
(22,'经营管理',NULL,NULL,701,1000),
(23,'可用房确认','hotel/available_room_check.html',NULL,702,703),
(24,'入住情况','hotel/room_occupancy_manage.html',NULL,704,705),
(25,'入住登记','hotel/check_in.html',NULL,706,707),
(26,'账单管理','hotel/bill_manage.html',NULL,708,709),
(27,'账单统计','hotel/bill_statistic.html',NULL,710,711);
