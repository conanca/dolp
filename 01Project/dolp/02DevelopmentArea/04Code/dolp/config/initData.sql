...
insert into SYSTEM_MENU values(1,'系统管理','','系统管理与设置',null,null,0);
insert into SYSTEM_MENU values(2,'用户管理','system/user_manage.jsp','系统管理与设置',null,1,1);
insert into SYSTEM_MENU values(3,'角色管理','system/role_manage.jsp','',null,1,1);
insert into SYSTEM_MENU values(4,'角色分配','system/role_assign.jsp','',null,1,1);
insert into SYSTEM_MENU values(5,'菜单管理','system/menu_manage.jsp','',null,1,1);
insert into SYSTEM_MENU values(6,'演示页面','','',null,null,0);
insert into SYSTEM_MENU values(7,'格式化文本框','demo1.jsp','',null,6,1);
insert into SYSTEM_MENU values(8,'酒店设置','','',null,null,0);
insert into SYSTEM_MENU values(9,'OOXX','1.jsp','',null,8,1);